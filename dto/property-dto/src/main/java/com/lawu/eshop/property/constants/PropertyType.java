...
public class PropertyType {
	...
	public final static String MEMBER_THIRD_PAY_POINT_DEFAULT = "1";
	...
	public final static String ad_commission_1_default = "0.03";
	public final static String ad_commission_2_default = "0.02";
