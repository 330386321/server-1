...
public enum MerchantTransactionTypeEnum {
	...
	LOWER_INCOME((byte)0x66, "广告提成", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME}),				//102--广告提成
...
//	DEPOSIT_REFUND((byte)0x72,"保证金退款"),				//114-需求说不要
	SALES_COMMISSION((byte) 0x73, "推荐E友收益", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME}),			//115--推荐E友收益
	VOLUME_COMMISSION((byte) 0x74, "推荐商家收益", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME}),			//116--推荐商家收益
