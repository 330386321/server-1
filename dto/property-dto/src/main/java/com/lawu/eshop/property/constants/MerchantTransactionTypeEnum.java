...
public enum MerchantTransactionTypeEnum {
	...
	ORDER((byte)0x65,"商品收入"),						//101--
	LOWER_INCOME((byte)0x66,"推荐E友收益"),				//102--
	RECHARGE((byte)0x67,"充值余额"),					//103--
	INTEGRAL_RECHARGE((byte)0x69,"充值积分"),				//105--
	WITHDRAW((byte)0x6B,"提现成功"),					//107--
...
//	DEPOSIT_REFUND((byte)0x72,"保证金退款"),				//114-需求说不要
	...
	VOLUME_COMMISSION((byte) 0x74, "推荐E友收益"),			//116--
	BACKAGE((byte) 0x75, "平台充值");					//117
