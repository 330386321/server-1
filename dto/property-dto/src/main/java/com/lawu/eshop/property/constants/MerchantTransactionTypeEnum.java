...
public enum MerchantTransactionTypeEnum {
	...
	PAY((byte)0x64, "买单收入", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.PAY_INCOME},"买单-"),						//100--
	ORDER((byte)0x65, "商品收入", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.PRODUCT_INCOME},"商品收入-"),						//101--
	LOWER_INCOME((byte)0x66, "广告提成", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME},"推荐E友收益"),				//102--广告提成
	RECHARGE((byte)0x67, "充值余额", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECHARGE}, "充值余额"),					//103--
	INTEGRAL_RECHARGE((byte)0x69, "充值积分", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECHARGE}, "充值积分"),				//105--
	WITHDRAW((byte)0x6B,"提现", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.WITHDRAW},"提现申请"),					//107--
	WITHDRAW_BACK((byte)0x6C,"提现失败", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.WITHDRAW, MerchantTransactionCategoryEnum.REFUND_MONEY},"提现失败退款"),				//108--
...
//	DEPOSIT_REFUND((byte)0x72,"保证金退款"),				//114-需求说不要
	SALES_COMMISSION((byte) 0x73, "推荐E友收益", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME}, "推荐E友收益"),			//115--推荐E友收益
	VOLUME_COMMISSION((byte) 0x74, "推荐商家收益", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECOMMEND_INCOME}, "推荐E友收益"),			//116--推荐商家收益
	BACKAGE((byte) 0x75, "平台充值", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.RECHARGE},""),					//117
      AD_DOWN((byte) 0x76, "红包未领取", new MerchantTransactionCategoryEnum[]{MerchantTransactionCategoryEnum.REFUND_MONEY},"退款-红包未领取"),				//118
