package com.lawu.eshop.pay.srv.sdk.weixin.sdk.common;
...
import com.lawu.eshop.pay.srv.sdk.weixin.sdk.protocol.refund_protocol.RefundResData;
import com.lawu.eshop.pay.srv.sdk.weixin.sdk.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest{
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(""/*Dict.getSys_base_path()*/));//加载本地的证书进行https加密传输
        try {
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, Configure.getCertPasswordMember().toCharArray())
                .build();
    ...
    public String sendPost(String url, Object xmlObj, JsonResult jsonResult) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        postDataXML = postDataXML.replaceAll("com.love.controller.thirdPlatform.wx.sdk.protocol.refund_protocol.RefundReqData", "xml");
