...
public class WxPayController extends BaseController {
	...
	public Result getPrepayInfo(@RequestBody AppAlipayDataParam param) throws JDOMException, IOException {
		int retCode = WxPayParamValidateor.appAlipayReqValidate(param);
		...
		String sign = PayCommonUtil.createSign("UTF-8", packageParams, Configure.key_app);
		...
		if (return_code.equals("FAIL")) {
			...
			logger.error("app微信支付预支付订单失败，return_code={},return_msg={}", return_code, return_msg);
			...
			if (result_code.equals("FAIL")) {
				...
				logger.error("app微信支付预支付订单失败，result_code={},err_code={},err_code_des={}", result_code, err_code,
						err_code_des);
