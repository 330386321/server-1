...
import com.lawu.eshop.pay.srv.sdk.alipay.sign.RSA;
...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String alipay_public_key) {
    ...
    public static boolean verifyApp(Map<String, String> params,String alipay_public_key) {
    	//写日志记录（若要调试，请取消下面两行注释）
        String rWord = "返回回来的参数：" + AlipayCore.createLinkString(params);
    	System.out.println(rWord);
...
//        System.out.println("待签名字符串："+preSignStr);
        ...
        if("RSA".equals(PropertiesUtil.getPropertyValue("sign_type", "alipay.properties"))){
        	isSign = RSA.verify(preSignStr, sign, alipay_public_key, PropertiesUtil.getPropertyValue("input_charset", "alipay.properties"));
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = PropertiesUtil.getPropertyValue("partner", "alipay.properties");
