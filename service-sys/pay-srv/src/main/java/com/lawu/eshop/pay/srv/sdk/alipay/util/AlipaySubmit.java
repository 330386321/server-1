...
//		System.out.println("sign：" + mysign);
	...
	private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
		...
		sPara.put("sign_type", PropertiesUtil.getPropertyValue("sign_type", "alipay.properties"));
		return sPara;
	}
	...
	public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
				+ "_input_charset=" + PropertiesUtil.getPropertyValue("input_charset", "alipay.properties")
				+ "\" method=\"" + strMethod + "\">");
	...
	public static String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
				+ PropertiesUtil.getPropertyValue("partner", "alipay.properties") + "&_input_charset"
				+ PropertiesUtil.getPropertyValue("input_charset", "alipay.properties");
