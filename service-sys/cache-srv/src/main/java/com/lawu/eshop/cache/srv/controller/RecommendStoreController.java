...
public class RecommendStoreController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "saveNewMerchant", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "saveRecommendFoodConsume", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "saveRecommendFoodComment", method = RequestMethod.GET)
