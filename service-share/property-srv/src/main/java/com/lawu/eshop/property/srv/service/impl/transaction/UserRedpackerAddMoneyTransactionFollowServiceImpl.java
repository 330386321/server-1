 ...
 */
@Service
@CompensatingTransactionFollow(topic = MqConstant.TOPIC_AD_SRV, tags = MqConstant.TAG_AD_USER_REDPACKET_ADD_MONTY)
public class UserRedpackerAddMoneyTransactionFollowServiceImpl
