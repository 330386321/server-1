...
public class ReportAdEarningsServiceImplTest {
	...
	@Autowired
	private ReportAdEarningsServiceImpl reportAdEarningsServiceImpl;
	...
	public void saveReportAdEarnings() {
		...
		reportAdEarningsServiceImpl.saveReportAdEarnings(reportAdEarningsParam);
	...
	public void selectReportAdEarnings() {
		...
		Page<ReportAdEarningsBO> page = reportAdEarningsServiceImpl.selectReportAdEarnings(query);
	...
	public void getReportAdEarningsIds() {
		...
		reportAdEarningsServiceImpl.getReportAdEarningsIds();
	}
}
