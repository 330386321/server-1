package com.lawu.eshop.user.srv.db;
...
public class MybatisDataSource {
    ...
    public DataSource dataSource() {
        ...
        datasource.setUrl(userSrvConfig.getUrl());
        datasource.setDbType(userSrvConfig.getType());
        datasource.setDriverClassName(userSrvConfig.getDriver());
        datasource.setUsername(userSrvConfig.getUsername());
        datasource.setPassword(userSrvConfig.getPassword());
        return datasource;
    }
