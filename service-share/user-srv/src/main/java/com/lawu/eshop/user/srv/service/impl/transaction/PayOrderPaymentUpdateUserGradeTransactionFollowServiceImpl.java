...
/**
 * 买单支付订单成功后修改用户等级事务处理-从模块
 *
 * @author yangqh
 * @date 2017年11月24日
 */
@Service("payOrderPaymentUpdateUserGradeTransactionFollowServiceImpl")
@CompensatingTransactionFollow(topic = MqConstant.TOPIC_PROPERTY_SRV, tags = MqConstant.TAG_PAY_ORDER_PAY_UPDATE_USER_GRADE)
public class PayOrderPaymentUpdateUserGradeTransactionFollowServiceImpl extends AbstractTransactionFollowService<SalesOrderPaymentUpdateUserGradeNotification, Reply> {
