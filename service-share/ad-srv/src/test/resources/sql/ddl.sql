...
CREATE TABLE `ad` (
  ...
  `relate_id` bigint(20) COMMENT '关联id',
  `relate_type` tinyint(2) DEFAULT 0  COMMENT '关联类型 0 没有关联 1店铺 2 商品' ,
  ...
  `file_size` varchar(10) DEFAULT NULL COMMENT '视频大小',
  `file_time` varchar(10) DEFAULT NULL COMMENT '视频长度',
