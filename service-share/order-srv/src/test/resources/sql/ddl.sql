...
CREATE TABLE `shopping_refund_detail` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `shopping_order_item_id` bigint(20) unsigned NOT NULL,
  `type` tinyint(2) unsigned NOT NULL,
  `reason` varchar(100) NOT NULL,
  `description` varchar(200) DEFAULT NULL,
  `voucher_picture` varchar(150) DEFAULT NULL,
  `refusal_reasons` varchar(200) DEFAULT NULL,
  ...
  `is_agree` tinyint(1) unsigned DEFAULT NULL,
  `gmt_refund` datetime DEFAULT NULL,
  `gmt_confirmed` datetime DEFAULT NULL,
  `gmt_fill` datetime DEFAULT NULL,
  `gmt_submit` datetime DEFAULT NULL,
  `gmt_intervention` datetime DEFAULT NULL,
  `gmt_create` datetime NOT NULL,
  `gmt_modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
);
