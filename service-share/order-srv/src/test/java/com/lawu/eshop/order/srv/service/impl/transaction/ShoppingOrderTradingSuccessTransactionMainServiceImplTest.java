...
public class ShoppingOrderTradingSuccessTransactionMainServiceImplTest {

	@SuppressWarnings("rawtypes")
	@Autowired
	@Qualifier("shoppingOrderTradingSuccessTransactionMainServiceImpl")
	private TransactionMainService shoppingOrderTradingSuccessTransactionMainServiceImpl;
	...
	public void receiveNotice() {
    	...
    	// 发送消息
		shoppingOrderTradingSuccessTransactionMainServiceImpl.sendNotice(expected.getId());
    	...
    	shoppingOrderTradingSuccessTransactionMainServiceImpl.receiveCallback(reply);
