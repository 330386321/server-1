...
public class ShoppingRefundAutoRemindRefundFailedJobTest {
    
    @Autowired
    private ShoppingRefundAutoRemindRefundFailedJob shoppingRefundAutoRemindRefundFailedJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoRemindRefundFailedJob.execute(shardingContext);
