...
public class ShoppingOrderTradingSuccessIncreaseSalesTransactionMainServiceImplTest {

	@SuppressWarnings("rawtypes")
	@Autowired
	@Qualifier("shoppingOrderTradingSuccessIncreaseSalesTransactionMainServiceImpl")
	private TransactionMainService shoppingOrderTradingSuccessIncreaseSalesTransactionMainServiceImpl;
	...
	public void receiveNotice() {
    	...
    	// 发送消息
		shoppingOrderTradingSuccessIncreaseSalesTransactionMainServiceImpl.sendNotice(expected.getId());
    	...
    	shoppingOrderTradingSuccessIncreaseSalesTransactionMainServiceImpl.receiveCallback(reply);
