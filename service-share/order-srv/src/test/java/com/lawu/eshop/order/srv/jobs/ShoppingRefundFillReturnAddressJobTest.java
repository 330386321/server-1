...
public class ShoppingRefundFillReturnAddressJobTest {
    
    @Autowired
    private ShoppingRefundFillReturnAddressJob shoppingRefundFillReturnAddressJob;
    ...
    public void execute() {
        ...
        shoppingRefundFillReturnAddressJob.execute(shardingContext);
