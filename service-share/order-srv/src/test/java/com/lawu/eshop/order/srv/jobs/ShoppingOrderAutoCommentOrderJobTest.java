...
public class ShoppingOrderAutoCommentOrderJobTest {
    
    @Autowired
    private ShoppingOrderAutoCommentOrderJob shoppingOrderAutoCommentOrderJob;
    ...
    public void execute() {
        ...
        shoppingOrderAutoCommentOrderJob.execute(shardingContext);
