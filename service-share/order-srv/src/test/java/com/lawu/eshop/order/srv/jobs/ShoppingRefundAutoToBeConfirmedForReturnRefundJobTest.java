...
public class ShoppingRefundAutoToBeConfirmedForReturnRefundJobTest {
    
    @Autowired
    private ShoppingRefundAutoToBeConfirmedForReturnRefundJob shoppingRefundAutoToBeConfirmedForReturnRefundJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoToBeConfirmedForReturnRefundJob.execute(shardingContext);
