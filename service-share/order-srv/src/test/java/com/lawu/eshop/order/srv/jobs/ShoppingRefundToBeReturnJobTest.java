...
public class ShoppingRefundToBeReturnJobTest {
    
    @Autowired
    private ShoppingRefundToBeReturnJob shoppingRefundToBeReturnJob;
    ...
    public void execute() {
        ...
        shoppingRefundToBeReturnJob.execute(shardingContext);
