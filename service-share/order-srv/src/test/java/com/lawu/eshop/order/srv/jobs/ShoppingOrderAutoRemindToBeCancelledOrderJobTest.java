...
public class ShoppingOrderAutoRemindToBeCancelledOrderJobTest {
    
    @Autowired
    private ShoppingOrderAutoRemindToBeCancelledOrderJob shoppingOrderAutoRemindToBeCancelledOrderJob;
    ...
    public void execute() {
        ...
        shoppingOrderAutoRemindToBeCancelledOrderJob.execute(shardingContext);
