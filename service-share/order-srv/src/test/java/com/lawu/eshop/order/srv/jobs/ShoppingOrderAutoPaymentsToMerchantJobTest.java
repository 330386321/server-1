...
public class ShoppingOrderAutoPaymentsToMerchantJobTest {
    
    @Autowired
    private ShoppingOrderAutoPaymentsToMerchantJob shoppingOrderAutoPaymentsToMerchantJob;
    ...
    public void execute() {
        ...
        shoppingOrderAutoPaymentsToMerchantJob.execute(shardingContext);
