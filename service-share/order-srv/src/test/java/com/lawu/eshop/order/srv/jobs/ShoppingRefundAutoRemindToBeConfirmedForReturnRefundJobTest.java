...
public class ShoppingRefundAutoRemindToBeConfirmedForReturnRefundJobTest {
    
    @Autowired
    private ShoppingRefundAutoRemindToBeConfirmedForReturnRefundJob shoppingRefundAutoRemindToBeConfirmedForReturnRefundJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoRemindToBeConfirmedForReturnRefundJob.execute(shardingContext);
