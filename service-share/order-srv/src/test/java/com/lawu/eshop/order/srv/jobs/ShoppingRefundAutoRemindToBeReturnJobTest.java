...
public class ShoppingRefundAutoRemindToBeReturnJobTest {
    
    @Autowired
    private ShoppingRefundAutoRemindToBeReturnJob shoppingRefundAutoRemindToBeReturnJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoRemindToBeReturnJob.execute(shardingContext);
