...
public class ShoppingCartConverterTest {
	...
	@Test
	public void convertShoppingCartUpdateQuantityDO() {
		ShoppingCartSaveParam expected = initShoppingCartSaveParam();
		Long id = 1L;
		ShoppingCartUpdateQuantityDO actual = ShoppingCartConverter.convertShoppingCartUpdateQuantityDO(expected, id);
		Assert.assertNotNull(actual);
