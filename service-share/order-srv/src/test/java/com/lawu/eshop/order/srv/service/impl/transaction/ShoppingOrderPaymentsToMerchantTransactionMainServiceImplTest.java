...
public class ShoppingOrderPaymentsToMerchantTransactionMainServiceImplTest {

	@SuppressWarnings("rawtypes")
	@Autowired
	@Qualifier("shoppingOrderPaymentsToMerchantTransactionMainServiceImpl")
	private TransactionMainService shoppingOrderPaymentsToMerchantTransactionMainServiceImpl;
	...
	public void receiveNotice() {
    	...
    	// 发送消息
		shoppingOrderPaymentsToMerchantTransactionMainServiceImpl.sendNotice(expected.getId());
    	...
    	shoppingOrderPaymentsToMerchantTransactionMainServiceImpl.receiveCallback(reply);
