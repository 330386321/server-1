...
public class ShoppingRefundAgreeToRefundTransactionMainServiceImplTest {

	@SuppressWarnings("rawtypes")
	@Autowired
	@Qualifier("shoppingRefundAgreeToRefundTransactionMainServiceImpl")
	private TransactionMainService shoppingRefundAgreeToRefundTransactionMainServiceImpl;
	...
	public void receiveNotice() {
    	...
    	shoppingRefundAgreeToRefundTransactionMainServiceImpl.receiveCallback(reply);
