...
public class ShoppingOrderPaymentTransactionFollowServiceImplTest {
    ...
    public void receiveNotice() {
    	...
    	notification.setPaymentMethod((byte) 2);
		notification.setTransactionId(1L);
		notification.setThirdNumber("123456");
		shoppingOrderPaymentTransactionFollowServiceImpl.receiveNotice(notification);
