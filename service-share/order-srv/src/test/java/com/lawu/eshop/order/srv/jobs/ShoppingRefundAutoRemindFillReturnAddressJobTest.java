...
public class ShoppingRefundAutoRemindFillReturnAddressJobTest {
    
    @Autowired
    private ShoppingRefundAutoRemindFillReturnAddressJob shoppingRefundAutoRemindFillReturnAddressJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoRemindFillReturnAddressJob.execute(shardingContext);
