...
public class ShoppingRefundAutoRemindToBeRefundWithRefundJobTest {
    
    @Autowired
    private ShoppingRefundAutoRemindToBeRefundWithRefundJob shoppingRefundAutoRemindToBeRefundWithRefundJob;
    ...
    public void execute() {
        ...
        shoppingRefundAutoRemindToBeRefundWithRefundJob.execute(shardingContext);
