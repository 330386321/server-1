...
public class DiscountPackageContentConverterTest {
    ...
    public void convert() {
        ...
        packageContentDO.setStatus(StatusEnum.STATUS_VALID.val);
        ...
        Assert.assertTrue(packageContentDO.getStatus().equals(discountPackageContentBO.getStatus().val));
    ...
    public void convertDiscountPackageContentBOList() {
        ...
        Assert.assertTrue(discountPackageContentDOList.get(0).getStatus().equals(list.get(0).getStatus().val));
