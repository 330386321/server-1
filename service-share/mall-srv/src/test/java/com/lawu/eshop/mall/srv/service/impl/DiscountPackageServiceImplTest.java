...
public class DiscountPackageServiceImplTest {
	...
	public void get() {
		...
		discountPackageContentDO.setStatus(StatusEnum.STATUS_VALID.val);
		...
		image.setStatus(StatusEnum.STATUS_VALID.val);
	...
	public void delete() {
		...
		packageDO.setStatus(StatusEnum.STATUS_VALID.val);
		...
		Assert.assertEquals(StatusEnum.STATUS_INVALID.val, discountPackageDOS.get(0).getStatus());
	}
	...
	public void deleteList() {
		...
		Assert.assertEquals(StatusEnum.STATUS_INVALID.val, discountPackageDOS.get(0).getStatus());
		Assert.assertEquals(StatusEnum.STATUS_INVALID.val, discountPackageDOS.get(1).getStatus());
	}
