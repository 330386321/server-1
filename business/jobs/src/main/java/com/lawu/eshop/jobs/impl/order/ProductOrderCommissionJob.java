 ...
 *
 */
public class ProductOrderCommissionJob extends AbstractWholePageJob<ShoppingOrderCommissionDTO> {
	...
	public void executePage(List<ShoppingOrderCommissionDTO> dataPage) throws JobsExtendPageException {
		saleAndVolumeCommissionService.commission(dataPage,2, "购物提成");
	}
