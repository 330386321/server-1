...
public class ProductControllerTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(productController).addInterceptors(authorizationInterceptor).build();
    }

    @Test
    public void selectProductById() {
        RequestBuilder request = get("/product/1").header("authorization","").param("productId","1");
        try {
