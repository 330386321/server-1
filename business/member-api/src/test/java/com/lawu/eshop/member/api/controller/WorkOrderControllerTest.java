...
public class WorkOrderControllerTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(workOrderController).addInterceptors(authorizationInterceptor).build();
    }
    
    
    @Test
    public void saveWorkOrder() {
        RequestBuilder request = post("/workOrder/saveWorkOrder").header("authorization","").param("content", "11111111111111111");
        try {
