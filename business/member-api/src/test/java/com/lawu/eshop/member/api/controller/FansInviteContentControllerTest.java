...
public class FansInviteContentControllerTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(fansInviteContentController).addInterceptors(authorizationInterceptor).build();
    }
    
    @SuppressWarnings("unused")
	@Test
    public void selectInviteContentById() {
    	RequestBuilder request = get("/fansInviteContent/selectInviteContentById/1/2").header("authorization","").param("id","1").param("relateId", "2");
        try {
