...
public class ProductSolrController extends BaseController {
    ...
    public Result<Page<ProductSolrDTO>> listProductByCategoryId(@ModelAttribute @ApiParam(required = true, value = "查询条件") ProductSolrParam productSolrParam) {
    ...
    public Result<Page<ProductSolrDTO>> listRecommendProduct(@ModelAttribute @ApiParam(required = true, value = "查询条件") ProductSolrParam productSolrParam) {
    ...
    public Result<Page<ProductSolrDTO>> listProductByName(@ModelAttribute @ApiParam(required = true, value = "查询条件") ProductSolrParam productSolrParam) {
