...
public class TransactionDetailControllerTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(transactionDetailController).build();
    }

    @Test
    public void addAddress() {
        MultiValueMap<String, String> map = new LinkedMultiValueMap<>();
        map.add("consumptionType", "EXPENDITURE");
        RequestBuilder request = get("/transactionDetail/findPageByUserNum").header("authorization", "8888").params(map);
        try {
