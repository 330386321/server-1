...
alter table member_ad_record add KEY idx_member_id(member_id);
...
-- mall
alter table comment_image add KEY idx_comment_id_status(comment_id, status);
...
alter table pay_order add KEY idx_member_id(member_id);
alter table pay_order add KEY idx_member_id_status(member_id, status);
alter table pay_order add KEY idx_merchant_id(merchant_id);
...
alter table shopping_order add KEY idx_member_id(member_id);
alter table shopping_order add KEY idx_member_id_status_order_status(member_id, status, order_status);
alter table shopping_order add KEY idx_merchant_id(merchant_id);
...
alter table product_image add KEY idx_product_id_status_img_type(product_id, status, img_type);
...
alter table freeze add KEY idx_user_num(user_num);
...
alter table invite_relation add KEY idx_invite_user_num(invite_user_num);
