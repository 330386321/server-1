...
CREATE TABLE `user_red_packet` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='用户红包表';

-- ----------------------------
-- Table structure for user_taked_red_packet
-- ----------------------------
...
CREATE TABLE `user_taked_red_packet` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COMMENT='用户红包分配表';